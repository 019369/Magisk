...
import com.zzqy.shaper.databinding.ComparableRv
import com.zzqy.shaper.databinding.ObservableDiffRvItem
import com.zzqy.shaper.databinding.addOnPropertyChangedCallback
...
class ProcessRvItem(
    ...
    var isEnabled
        ...
        set(value) = set(value, process.isEnabled, { process.isEnabled = it }, BR.enabled) {
            ...
            Shell.cmd("shaper --denylist $arg $pkg \'$name\'").submit()
        }
