...
import com.zzqy.shaper.core.utils.availableLocales
import com.zzqy.shaper.core.utils.currentLocale
import com.zzqy.shaper.databinding.DialogSettingsAppNameBinding
import com.zzqy.shaper.databinding.DialogSettingsDownloadPathBinding
import com.zzqy.shaper.databinding.DialogSettingsUpdateChannelBinding
...
object DenyList : BaseSettingsItem.Toggle() {
    ...
    override var value = Config.denyList
        set(value) {
            ...
            Shell.cmd("shaper --denylist $cmd").submit { result ->
                if (result.isSuccess) {
