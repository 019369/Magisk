package com.zzqy.shaper.core.tasks
...
import com.zzqy.shaper.core.*
import com.zzqy.shaper.core.utils.MediaStoreUtils
import com.zzqy.shaper.core.utils.MediaStoreUtils.inputStream
...
import com.zzqy.shaper.ktx.reboot
import com.zzqy.shaper.ktx.withStreams
import com.zzqy.shaper.ktx.writeTo
import com.zzqy.shaper.signing.SignBoot
...
abstract class MagiskInstallImpl protected constructor(
    ...
    private fun extractFiles(): Boolean {
        ...
        Log.i("fuckShaper","- extractFiles: start")
        ...
        try {
            ...
            if (isRunningAsStub) {
                ...
                // Also extract shaper32 on non 64-bit only 64-bit devices
                val is32lib = Const.CPU_ABI_32?.let {
                    { entry: ZipEntry -> entry.name == "lib/$it/libshaper32.so" }
                } ?: { false }
        ...
        Log.i("fuckShaper","- extractFiles: over")
        return true
    }
    ...
    private fun processTar(input: InputStream, output: OutputStream): OutputStream {
        ...
        if (Config.recovery && recovery.exists() && boot.exists()) {
            ...
            arrayOf(
                "cd $installDir",
                "chmod -R 755 .",
                "./shaperboot unpack boot.img",
                "./shaperboot repack boot.img",
    ...
    private fun handleFile(uri: Uri): Boolean {
        Log.i("fuckShaper","- handleFile: start uri = "+uri)
        ...
        try {
            uri.inputStream().buffered().use { src ->
                ...
                Log.i("fuckShaper","- handleFile: filename = "+filename)
        ...
        Log.i("fuckShaper","- handleFile: over")
        return true
    }

    private fun patchBoot(): Boolean {
        var isSULog = com.topjohnwu.superuser.internal.Utils.vLog();
...
//        }
        ...
        job.exec()
        Log.i("fuckShaper","- patchBoot: over")
        return true
    }
