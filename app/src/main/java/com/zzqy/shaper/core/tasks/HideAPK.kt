...
import com.zzqy.shaper.core.Provider
import com.zzqy.shaper.core.utils.AXML
import com.zzqy.shaper.core.utils.Keygen
import com.zzqy.shaper.di.ServiceLocator
import com.zzqy.shaper.ktx.await
import com.zzqy.shaper.ktx.writeTo
import com.zzqy.shaper.signing.JarMap
import com.zzqy.shaper.signing.SignApk
import com.zzqy.shaper.utils.APKInstall
...
object HideAPK {
    ...
    private suspend fun patchAndHide(activity: Activity, label: String, onFailure: Runnable): Boolean {
        ...
        try {
            ...
            Timber.e(e)
            stub.createNewFile()
            val cmd = "\$SHAPERBIN/shaperinit -x manager ${stub.path}"
